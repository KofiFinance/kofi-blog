...
import ValidatorProfitCalculator from "@site/src/components/ValidatorProfitCalculator";
...
_Profit = (Total Stake Delegated × APT Price × Network APR × Validator Commission Rate) - Annual Validator Cost_
